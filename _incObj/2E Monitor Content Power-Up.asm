...
Pow_ChkSonic:
	...
	ExtraLife:
		...
		bra.w	PlaySound	; play extra life music
; ===========================================================================
...
Pow_ChkShoes:
		...
		bra.w	PlaySound		; Speed	up the music
; ===========================================================================
...
Pow_ChkShield:
		...
		bra.w	PlaySound	; play shield sound
; ===========================================================================
...
Pow_ChkInvinc:
		...
		bra.w	PlaySound ; play invincibility music
; ===========================================================================
...
Pow_ChkRings:
	...
	Pow_RingSound:
		move.w	#sfx_Ring,d0
		bra.w	PlaySound	; play ring sound
; ===========================================================================
