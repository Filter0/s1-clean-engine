...
Pow_ChkSonic:
	...
	ExtraLife:
		...
		jmp	PlaySound(pc)	; play extra life music
; ===========================================================================
...
Pow_ChkShoes:
		...
		jmp	PlaySound(pc)		; Speed	up the music
; ===========================================================================
...
Pow_ChkShield:
		...
		jmp	PlaySound(pc)	; play shield sound
; ===========================================================================
...
Pow_ChkInvinc:
		...
		jmp	PlaySound(pc) ; play invincibility music
; ===========================================================================
...
Pow_ChkRings:
	...
	Pow_RingSound:
		move.w	#sfx_Ring,d0
		jmp	PlaySound(pc)	; play ring sound
; ===========================================================================
